...
helpme1 = '''Данный бот поможет вам советом, как правильно выбросить мусор.
...
randomLink = ["https://random.dog/woof.json","https://randomfox.ca/floof/","https://random-d.uk/api/random"]
